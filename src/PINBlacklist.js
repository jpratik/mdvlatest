...
function PINBlackList ( props){
  ...
  const LocationDataMenu = {
    id: "1",
    label: "City Of Angels Condos",
    items: [
      {
        label: "City Of Angels Condos",
        callback: () =>  {}
...
<div  sx={{
      ...
      <Typography sx={mainThemeStyle.popUpLable} height={40}></Typography>
      <Button sx={mainThemeStyle.normalButton} onClick={handleSaveCardFormat}>Save Blacklistt PINs</Button>
      </Stack>
      </Grid>
