...
<div  sx={{
      ...
      <Typography  sx={mainThemeStyle.popUpLable} height={40}>Tablet Name </Typography>
      ...
      <Button sx={mainThemeStyle.normalButton} onClick={handleCreateLocation}>Create Location</Button>
      </Stack>
      </Stack>
      </Grid>
     ...
     />
      <NestedButtonDropdown
          ...
          />
          <NestedButtonDropdown
            itemId={PINLength.id} // NOTE: itemId is required for track items
            variant="contained"
            sx={{ color: 'rgba(135, 135, 135, 0.5)',
            height:'34px',
            borderRadius: '5px',
     ...
     />
      ...
      <Typography sx={mainThemeStyle.popUpLable} height={40}> Location Telephone Dial </Typography>
