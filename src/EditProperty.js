...
<div  sx={{
      ...
      <Typography sx={mainThemeStyle.popUpLable} height={40}> Subscription </Typography>
      <Typography sx={mainThemeStyle.popUpLable} height={40}> Total Unit </Typography>
      <Typography  sx={mainThemeStyle.popUpLable} height={40}>User Cost</Typography>
      ...
      <Typography  sx={mainThemeStyle.popUpLable} height={40}>Choose Dealer </Typography>
      ...
      <TextField
                        ...
                        type= 'text'
                        name="text"
                        value="Mydoorview Annual Subscription"
                        sx={mainThemeStyle.InputMenuItem}
                        InputLabelProps={{ shrink: true }
                      }
     ...
     <TextField
        ...
        type="text"
        defaultValue="Market Place Property Manager"
        sx={mainThemeStyle.InputMenuItem}
                        InputLabelProps={{ shrink: true }
                      }
