...
<div  sx={{
      ...
      <Typography  sx={mainThemeStyle.popUpLable} height={40}>Assign Dealer </Typography>
      
      <Stack direction="row" spacing={2}>
      <Button sx={mainThemeStyle.normalButton} onClick={handleCancel}>Cancel</Button>
      <Button sx={mainThemeStyle.normalButton} onClick={handleCreateLocation}>Create New Property</Button>
      </Stack>
      </Stack>
      </Grid>
      ...
      <NestedButtonDropdown
            itemId={SubscriptionType.id} // NOTE: itemId is required for track items
            variant="contained"
     ...
     <TextField
       ...
       type="text"
       onChange={hanldeAddressLineOneChanged}
        value={addressLineOneTextEntered}
       height={40}
       sx={mainThemeStyle.InputMenuItem}
       InputLabelProps={{
         shrink: true,
     ...
     />
      ...
      <NestedButtonDropdown
            itemId={DealerType.id} // NOTE: itemId is required for track items
            variant="contained"
            sx={{ color: 'rgba(135, 135, 135, 0.5)',
            height:'34px',
            borderRadius: '5px',
      ...
      <Typography  sx={mainThemeStyle.popUpLable} height={40}>Note/Memo</Typography>
      ...
      <TextField
                    ...
                    />
                     <TextField
                        ...
                        type= 'text'
                        name="text"
                        onChange={hanldeSettingRefreshRateChanged}
                        value={settingRefreshRateTextEntered}
                        sx={mainThemeStyle.InputMenuItem}
                        InputLabelProps={{ shrink: true }
                      }
       ...
       type="text"
       onChange={hanldeAddressLineTwoChanged}
        value={addressLineTwoTextEntered}
       height={40}
       sx={mainThemeStyle.InputMenuItem}
       InputLabelProps={{
         shrink: true,
