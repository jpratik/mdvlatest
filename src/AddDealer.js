...
<div  sx={{
      ...
      <Typography  sx={mainThemeStyle.popUpLable} height={40}>Choose Distributor </Typography>
      ...
      <Button sx={mainThemeStyle.normalButton} onClick={handleCreateLocation}>Add Dealer</Button>
      </Stack>
      </Stack>
      </Grid>
      ...
      <NestedButtonDropdown
            itemId={DistributorType.id} // NOTE: itemId is required for track items
            variant="contained"
