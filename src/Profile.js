...
<div  sx={{
      ...
      <Button sx={mainThemeStyle.normalButton} onClick={handleSaveCardFormat}>Update Details</Button>
      </Stack>
      </Grid>
      ...
      <TextField
                   ...
                   <TextField
                       ...
                       type= 'text'
                       name="text"
                     defaultValue="First Street Avenue Mart"
                       sx={mainThemeStyle.InputMenuItem}
                       InputLabelProps={{ shrink: true }
                     }
      ...
      <TextField
                    ...
                    <TextField
                        ...
                        type= 'text'
                        name="text"
                        defaultValue="Cornerstone Security"
                        sx={mainThemeStyle.InputMenuItem}
                        InputLabelProps={{ shrink: true }
                      }
